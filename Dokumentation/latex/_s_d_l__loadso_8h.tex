...
\begin{DoxyCompactList}\small\item\em This function dynamically loads a shared object and returns a pointer to the object handle (or N\+U\+L\+L if there was an error). \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} void $\ast${\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Load\+Function} (void $\ast$handle, const char $\ast$name)
\begin{DoxyCompactList}\small\item\em Given an object handle, this function looks up the address of the named function in the shared object and returns it. \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} void {\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Unload\+Object} (void $\ast$handle)\label{_s_d_l__loadso_8h_a041e43c276cb826c2034eff220be7fe4}

\begin{DoxyCompactList}\small\item\em Unload a shared object from memory. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
This address is no longer valid after calling \doxyref{S\+D\+L\+\_\+\+Unload\+Object()}{p.}{_s_d_l__loadso_8h_a041e43c276cb826c2034eff220be7fe4}. \index{S\+D\+L\+\_\+loadso.\+h@{S\+D\+L\+\_\+loadso.\+h}!S\+D\+L\+\_\+\+Load\+Object@{S\+D\+L\+\_\+\+Load\+Object}}
...
This function dynamically loads a shared object and returns a pointer to the object handle (or N\+U\+L\+L if there was an error). 

The \textquotesingle{}sofile\textquotesingle{} parameter is a system dependent name of the object file. 