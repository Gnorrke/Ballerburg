...
\begin{DoxyCompactList}\small\item\em When filling in the desired audio spec structure,. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactItemize}
\item 
\#define {\bf S\+D\+L\+\_\+\+Load\+W\+A\+V}(file,  spec,  audio\+\_\+buf,  audio\+\_\+len)~{\bf S\+D\+L\+\_\+\+Load\+W\+A\+V\+\_\+\+R\+W}(S\+D\+L\+\_\+\+R\+W\+From\+File(file, \char`\"{}rb\char`\"{}),1, spec,audio\+\_\+buf,audio\+\_\+len)\label{_s_d_l__audio_8h_a611f76dc30ba9891239bcce3f9b472b5}

\begin{DoxyCompactList}\small\item\em Compatibility convenience function -- loads a W\+A\+V from a file. \end{DoxyCompactList}\item 
...
\item 
\#define {\bf A\+U\+D\+I\+O\+\_\+\+U8}~0x0008\label{_s_d_l__audio_8h_a6468b4b3fc53ada655eca866e491d75f}

\begin{DoxyCompactList}\small\item\em Unsigned 8-\/bit samples. \end{DoxyCompactList}\item 
\#define {\bf A\+U\+D\+I\+O\+\_\+\+S8}~0x8008\label{_s_d_l__audio_8h_a883b3d4539451e49bf014dde0f9cca29}

\begin{DoxyCompactList}\small\item\em Signed 8-\/bit samples. \end{DoxyCompactList}\item 
\#define {\bf A\+U\+D\+I\+O\+\_\+\+U16\+L\+S\+B}~0x0010\label{_s_d_l__audio_8h_a06808f806896c4d211314990c354b7fc}

\begin{DoxyCompactList}\small\item\em Unsigned 16-\/bit samples. \end{DoxyCompactList}\item 
\#define {\bf A\+U\+D\+I\+O\+\_\+\+S16\+L\+S\+B}~0x8010\label{_s_d_l__audio_8h_a23838d612e88ce72d82c3e51460f831b}

\begin{DoxyCompactList}\small\item\em Signed 16-\/bit samples. \end{DoxyCompactList}\item 
\#define {\bf A\+U\+D\+I\+O\+\_\+\+U16\+M\+S\+B}~0x1010\label{_s_d_l__audio_8h_a3b8052d0c49d14a2e3edf08eade52d3a}

\begin{DoxyCompactList}\small\item\em As above, but big-\/endian byte order. \end{DoxyCompactList}\item 
\#define {\bf A\+U\+D\+I\+O\+\_\+\+S16\+M\+S\+B}~0x9010\label{_s_d_l__audio_8h_a3109dfb1d7aab29dff2b62d630e690ca}
...
\begin{DoxyCompactList}\small\item\em When filling in the desired audio spec structure,. \end{DoxyCompactList}\item 
typedef struct {\bf S\+D\+L\+\_\+\+Audio\+C\+V\+T} {\bf S\+D\+L\+\_\+\+Audio\+C\+V\+T}\label{_s_d_l__audio_8h_acddd16bc3257a83299e7abe6d160ba0a}
...
\begin{DoxyCompactList}\small\item\em This function fills the given character buffer with the name of the current audio driver, and returns a pointer to it if the audio driver has been initialized. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em This function opens the audio device with the desired parameters, and returns 0 if successful, placing the actual hardware parameters in the structure pointed to by \textquotesingle{}obtained\textquotesingle{}. \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} S\+D\+L\+\_\+audiostatus {\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Get\+Audio\+Status} (void)\label{_s_d_l__audio_8h_a43b2a088225e6b1bf0c9feef4a9df918}

\begin{DoxyCompactList}\small\item\em Get the current audio state. \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} void {\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Pause\+Audio} (int pause\+\_\+on)
\begin{DoxyCompactList}\small\item\em This function pauses and unpauses the audio callback processing. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em This function loads a W\+A\+V\+E from the data source, automatically freeing that source if \textquotesingle{}freesrc\textquotesingle{} is non-\/zero. \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} void {\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Free\+W\+A\+V} (Uint8 $\ast$audio\+\_\+buf)\label{_s_d_l__audio_8h_a631aa8624575603df2c5ab9257feee59}

\begin{DoxyCompactList}\small\item\em This function frees data previously allocated with \doxyref{S\+D\+L\+\_\+\+Load\+W\+A\+V\+\_\+\+R\+W()}{p.}{_s_d_l__audio_8h_a7e5d38e8c1f8951704a76330c3b1ac81} \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em This function takes a source format and rate and a destination format and rate, and initializes the \textquotesingle{}cvt\textquotesingle{} structure with information needed by \doxyref{S\+D\+L\+\_\+\+Convert\+Audio()}{p.}{_s_d_l__audio_8h_a8e8660222356e07002dde4928118b7df} to convert a buffer of audio data from one format to the other. \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} int {\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Convert\+Audio} ({\bf S\+D\+L\+\_\+\+Audio\+C\+V\+T} $\ast$cvt)
\begin{DoxyCompactList}\small\item\em Once you have initialized the \textquotesingle{}cvt\textquotesingle{} structure using \doxyref{S\+D\+L\+\_\+\+Build\+Audio\+C\+V\+T()}{p.}{_s_d_l__audio_8h_ab89d6be44de5fbe6d06fe59e05975e68}, created an audio buffer cvt-\/$>$buf, and filled it with cvt-\/$>$len bytes of audio data in the source format, this function will convert it in-\/place to the desired format. \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} void {\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Mix\+Audio} (Uint8 $\ast$dst, const Uint8 $\ast$src, Uint32 len, int volume)
\begin{DoxyCompactList}\small\item\em This takes two audio buffers of the playing audio format and mixes them, performing addition, volume adjustment, and overflow clipping. \end{DoxyCompactList}\item 
{\bf D\+E\+C\+L\+S\+P\+E\+C} void {\bf S\+D\+L\+C\+A\+L\+L} {\bf S\+D\+L\+\_\+\+Close\+Audio} (void)\label{_s_d_l__audio_8h_aa176acc650e66e1d38814cbed3ca258e}

\begin{DoxyCompactList}\small\item\em This function shuts down audio processing and closes the audio device. \end{DoxyCompactList}\end{DoxyCompactItemize}
\begin{Indent}{\bf Audio Init and Quit}\par
{\em These functions are used internally, and should not be used unless you have a specific need to specify the audio driver you want to use.
...
{\em The lock manipulated by these functions protects the callback function.

During a Lock\+Audio/\+Unlock\+Audio pair, you can be guaranteed that the callback function is not running. Do not call these from the callback function or you will cause deadlock. }\begin{DoxyCompactItemize}
\item 
...
It returns N\+U\+L\+L if no driver has been initialized. \index{S\+D\+L\+\_\+audio.\+h@{S\+D\+L\+\_\+audio.\+h}!S\+D\+L\+\_\+\+Build\+Audio\+C\+V\+T@{S\+D\+L\+\_\+\+Build\+Audio\+C\+V\+T}}
...
The data conversion may expand the size of the audio data, so the buffer cvt-\/$>$buf should be allocated after the cvt structure is initialized by \doxyref{S\+D\+L\+\_\+\+Build\+Audio\+C\+V\+T()}{p.}{_s_d_l__audio_8h_ab89d6be44de5fbe6d06fe59e05975e68}, and should be cvt-\/$>$len$\ast$cvt-\/$>$len\+\_\+mult bytes long. \index{S\+D\+L\+\_\+audio.\+h@{S\+D\+L\+\_\+audio.\+h}!S\+D\+L\+\_\+\+Load\+W\+A\+V\+\_\+\+R\+W@{S\+D\+L\+\_\+\+Load\+W\+A\+V\+\_\+\+R\+W}}
...
This function loads a W\+A\+V\+E from the data source, automatically freeing that source if \textquotesingle{}freesrc\textquotesingle{} is non-\/zero. 

For example, to load a W\+A\+V\+E file, you could do\+: 
\begin{DoxyCode}
...
The volume ranges from 0 -\/ 128, and should be set to S\+D\+L\+\_\+\+M\+I\+X\+\_\+\+M\+A\+X\+V\+O\+L\+U\+M\+E for full audio volume. Note this does not change hardware volume. This is provided for convenience -- you can mix your own audio data. \index{S\+D\+L\+\_\+audio.\+h@{S\+D\+L\+\_\+audio.\+h}!S\+D\+L\+\_\+\+Open\+Audio@{S\+D\+L\+\_\+\+Open\+Audio}}
...
This function opens the audio device with the desired parameters, and returns 0 if successful, placing the actual hardware parameters in the structure pointed to by \textquotesingle{}obtained\textquotesingle{}. 

If \textquotesingle{}obtained\textquotesingle{} is N\+U\+L\+L, the audio data passed to the callback function will be guaranteed to be in the requested format, and will be automatically converted to the hardware audio format if necessary. This function returns -\/1 if it failed to open the audio device, or couldn\textquotesingle{}t set up the audio thread.
...
It should be called with a parameter of 0 after opening the audio device to start playing sound. This is so you can safely initialize data for your callback function after opening the audio device. Silence will be written to the audio device during the pause. 