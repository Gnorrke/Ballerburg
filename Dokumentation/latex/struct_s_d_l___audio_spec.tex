...
\begin{DoxyCompactList}\small\item\em This function is called when the audio device needs more data. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Public Attributes}
\begin{DoxyCompactItemize}
\item 
int {\bf freq}\label{struct_s_d_l___audio_spec_a8b823ce46fc2e448cf7e6fc141aff6b2}

\begin{DoxyCompactList}\small\item\em D\+S\+P frequency -- samples per second. \end{DoxyCompactList}\item 
Uint16 {\bf format}\label{struct_s_d_l___audio_spec_a6eda133f50c3be8d0ba91f8dee830be8}

\begin{DoxyCompactList}\small\item\em Audio data format. \end{DoxyCompactList}\item 
Uint8 {\bf channels}\label{struct_s_d_l___audio_spec_a31fe8b3710cf23bbef24be8a1749fe46}

\begin{DoxyCompactList}\small\item\em Number of channels\+: 1 mono, 2 stereo. \end{DoxyCompactList}\item 
Uint8 {\bf silence}\label{struct_s_d_l___audio_spec_addc462c8a806e6c122eccf63482048f6}

\begin{DoxyCompactList}\small\item\em Audio buffer silence value (calculated) \end{DoxyCompactList}\item 
Uint16 {\bf samples}\label{struct_s_d_l___audio_spec_a2cdf5e885808c10bfa2810b706e69f95}

\begin{DoxyCompactList}\small\item\em Audio buffer size in samples (power of 2) \end{DoxyCompactList}\item 
Uint16 {\bf padding}\label{struct_s_d_l___audio_spec_a738371fc13b54cefef4db16994abeeb6}

\begin{DoxyCompactList}\small\item\em Necessary for some compile environments. \end{DoxyCompactList}\item 
Uint32 {\bf size}\label{struct_s_d_l___audio_spec_a154cf44743ecec78c36dc6c827dd2fdb}

\begin{DoxyCompactList}\small\item\em Audio buffer size in bytes (calculated) \end{DoxyCompactList}\item 
